...
The implementation writes CSV tables, PNG figures, serialized models, feature schemas, data manifests, and experiment manifests. The FULL run reported in this paper used Python 3.12.0 with NumPy 2.5.3, pandas 3.0.5, scikit-learn 1.9.1, XGBoost 3.4.1, SciPy 1.18.1, matplotlib 3.11.2, and joblib 1.6.0, executed on an Intel Core i7-14700K (20 physical / 28 logical cores) with 32~GB RAM running Windows 11 Pro (64-bit). Random seed 42 is used for sampling and model construction where supported; the descriptive cross-validation pass uses seed 43. No Git commit is reported for this execution because the repository had not yet been placed under version control at run time.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/05_supervised_benchmark.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/07_attackwise_recall.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/08_permutation_importance.png}}
...
The version associated with this manuscript corresponds to repository release \texttt{v1.0.0} and Git revision \texttt{<GIT\_COMMIT\_SHA>}. A preserved archival snapshot of this release is available through Zenodo at \url{https://doi.org/<ZENODO_DOI>}.
